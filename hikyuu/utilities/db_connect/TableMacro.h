...
#define COL_TABLE_BIND2(TableT, table, f1, f2)                                            \
public:                                                                                   \
    TableT() = default;                                                                   \
    TableT(const TableT&) = default;                                                      \
    TableT& operator=(const TableT&) = default;                                           \
...
public:                                                                                   \
    ...
    static const char* getInsertSQL() {                                                   \
        return "insert into \"" #table "\" (id, \"" #f1 "\",\"" #f2 "\") values (?,?,?)"; \
    }                                                                                     \
    static const char* getUpdateSQL() {                                                   \
        return "update \"" #table "\" set \"" #f1 "\"=?,\"" #f2 "\"=? where \"id\"=?";    \
    }                                                                                     \
...
public:                                                                                 \
    ...
    static const char* getUpdateSQL() {                                                 \
        return "update \"" #table "\" set \"" #f1 "\"=?,\"" #f2 "\"=?,\"" #f3           \
               "\"=? where \"id\"=?";                                                   \
    }                                                                                   \
    static const char* getSelectSQL() {                                                 \
        return "select \"id\",\"" #f1 "\",\"" #f2 "\",\"" #f3 "\" from \"" #table "\""; \
...
public:                                                                                       \
    ...
    static const char* getIndexFieldName() {                                                  \
        return "id";                                                                          \
    }                                                                                         \
    static const char* getInsertSQL() {                                                       \
...
#define COL_TABLE_BIND10(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10)                  \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
    TableT& operator=(const TableT&) = default;                                                   \
...
#define COL_TABLE_BIND11(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11)             \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
    TableT& operator=(const TableT&) = default;                                                   \
...
#define COL_TABLE_BIND12(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12)        \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
    TableT& operator=(const TableT&) = default;                                                   \
...
#define COL_TABLE_BIND13(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13)   \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
    TableT& operator=(const TableT&) = default;                                                   \
...
#define COL_TABLE_BIND14(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14)                                                                     \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
...
public:                                                                                           \
    ...
    void save(const SQLStatementPtr& st) const {                                                  \
        st->bind(0, m_id, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14);           \
    }                                                                                             \
    void update(const SQLStatementPtr& st) const {                                                \
        st->bind(0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, m_id);           \
    }                                                                                             \
...
#define COL_TABLE_BIND15(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14, f15)                                                                \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
...
public:                                                                                           \
    ...
    static const char* getSelectSQL() {                                                           \
        return "select \"id\",\"" #f1 "\",\"" #f2 "\",\"" #f3 "\",\"" #f4 "\",\"" #f5 "\",\"" #f6 \
               "\",\"" #f7 "\",\"" #f8 "\",\"" #f9 "\",\"" #f10 "\",\"" #f11 "\",\"" #f12         \
               "\",\"" #f13 "\",\"" #f14 "\",\"" #f15 "\" from \"" #table "\"";                   \
    }                                                                                             \
    void save(const SQLStatementPtr& st) const {                                                  \
        st->bind(0, m_id, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15);      \
    }                                                                                             \
    void update(const SQLStatementPtr& st) const {                                                \
        st->bind(0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, m_id);      \
    }                                                                                             \
...
#define COL_TABLE_BIND16(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14, f15, f16)                                                           \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
...
public:                                                                                           \
    ...
    static const char* getSelectSQL() {                                                           \
        return "select \"id\",\"" #f1 "\",\"" #f2 "\",\"" #f3 "\",\"" #f4 "\",\"" #f5 "\",\"" #f6 \
               "\",\"" #f7 "\",\"" #f8 "\",\"" #f9 "\",\"" #f10 "\",\"" #f11 "\",\"" #f12         \
               "\",\"" #f13 "\",\"" #f14 "\",\"" #f15 "\",\"" #f16 "\" from \"" #table "\"";      \
    }                                                                                             \
    void save(const SQLStatementPtr& st) const {                                                  \
        st->bind(0, m_id, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16); \
    }                                                                                             \
    void update(const SQLStatementPtr& st) const {                                                \
        st->bind(0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, m_id); \
    }                                                                                             \
...
#define COL_TABLE_BIND17(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14, f15, f16, f17)                                                      \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
...
#define COL_TABLE_BIND18(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14, f15, f16, f17, f18)                                                 \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
...
#define COL_TABLE_BIND19(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14, f15, f16, f17, f18, f19)                                            \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
...
#define COL_TABLE_BIND20(TableT, table, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13,   \
                         f14, f15, f16, f17, f18, f19, f20)                                       \
public:                                                                                           \
    TableT() = default;                                                                           \
    TableT(const TableT&) = default;                                                              \
